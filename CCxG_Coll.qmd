...
digraph flowchart {
  ...
  tab3 [label = '89 different arg-struc-cxn']
  tab4 [label = 'arg0(np)-v(v)-arg1(np)-arg2(pp)']
  tab5 [label = 'arg0(np)-v(v)-arg2(np)-arg1(np)']
  tab6 [label = 'Words in both cxn1 & cxn2']
  tab7 [label = 'Words exclusively in cxn1', fillcolor = lightcoral]
  tab8 [label = 'Words exclusively in cxn2', fillcolor = lightcoral]
  tab9 [label = 'Words that prefer cxn1 but also appear in cxn2']
  tab10 [label = 'Words that prefer cxn2 but also appear in cxn1']
